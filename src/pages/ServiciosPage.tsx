...
import {
  Globe, Smartphone, Zap, TrendingUp, ShoppingCart,
  Settings, Flame, CheckCircle2, ChevronRight,
} from "lucide-react";
...
const SERVICES = [
  ...
  },
  {
    ...
    features: ["Catálogo de productos", "Pasarela de pagos", "Gestión de inventario", "Notificaciones automáticas"],
    color: "#C0392B",
    glow: "rgba(192,57,43,0.25)",
    gradient: "linear-gradient(135deg, rgba(192,57,43,0.10), rgba(10,15,30,0.8))",
  },
  {
    ...
    features: ["Identidad de marca digital", "Estrategia de contenido", "Google My Business", "Análisis de competencia"],
  ...
  },
  {
    ...
    features: ["Actualizaciones periódicas", "Copias de seguridad", "Monitoreo 24/7", "Soporte técnico"],
    color: "#1B4F72",
    glow: "rgba(27,79,114,0.25)",
    gradient: "linear-gradient(135deg, rgba(27,79,114,0.15), rgba(10,15,30,0.8))",
  },
];

const PROCESS = [
  { step: "01", title: "Consulta inicial",     desc: "Conversamos sobre tu negocio, tus objetivos y lo que necesitas." },
  { step: "02", title: "Propuesta y plan",      desc: "Preparamos una propuesta a medida con tiempos y costos claros." },
  { step: "03", title: "Diseño y desarrollo",   desc: "Construimos tu solución con tecnologías modernas y eficientes." },
  { step: "04", title: "Entrega y soporte",     desc: "Lanzamos tu proyecto y te acompañamos en cada paso." },
];
    ...
    <Layout>
      ...
      <section className="relative pt-36 pb-20 px-6 overflow-hidden">
        <div className="absolute inset-0"
          style={{ background: "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(46,134,171,0.12) 0%, transparent 70%)" }} />
        <div className="absolute inset-0 pointer-events-none opacity-[0.035]"
          style={{
            backgroundImage: "linear-gradient(rgba(46,134,171,1) 1px, transparent 1px), linear-gradient(90deg, rgba(46,134,171,1) 1px, transparent 1px)",
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <motion.p
            ...
            style={{ fontFamily: "'Cinzel', serif", fontSize: "0.7rem", color: "#C0392B", letterSpacing: "0.3em", marginBottom: "1rem" }}
          >
            LO QUE HACEMOS
          </motion.p>
          ...
          <motion.h1
            ...
            style={{ fontFamily: "'Cinzel', serif", fontSize: "clamp(2.2rem, 5vw, 3.8rem)", fontWeight: 700, color: "#F0F4FF", lineHeight: 1.15, marginBottom: "1.25rem" }}
          >
      ...
      <section ref={cardsRef} className="py-16 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.map(({ icon: Icon, title, tagline, desc, features, color, glow, gradient }) => (
            <div
              key={title}
              className="srv-card group relative p-7 rounded-2xl transition-all duration-300 hover:-translate-y-2"
              style={{ background: gradient, border: "1px solid rgba(46,134,171,0.1)", backdropFilter: "blur(8px)" }}
              onMouseEnter={e => {
            ...
            >
              ...
              <p style={{ fontFamily: "'Exo 2', sans-serif", fontSize: "0.7rem", color, letterSpacing: "0.15em", marginBottom: "0.4rem" }}>
                {tagline.toUpperCase()}
              </p>

              <h3 style={{ fontFamily: "'Cinzel', serif", fontSize: "1rem", fontWeight: 600, color: "#E8EEF8", marginBottom: "0.75rem", lineHeight: 1.3 }}>
                {title}
              </h3>

              <p style={{ fontFamily: "'Exo 2', sans-serif", fontSize: "0.83rem", color: "#4A5A7A", lineHeight: 1.75, marginBottom: "1.25rem" }}>
                {desc}
              </p>
              ...
              <ul className="space-y-1.5">
                {features.map(f => (
                  <li key={f} className="flex items-center gap-2">
                    ...
                    <span style={{ fontFamily: "'Exo 2', sans-serif", fontSize: "0.78rem", color: "#6677AA" }}>{f}</span>
                  </li>
                ))}
              </ul>
      ...
      <section ref={processRef} className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            {/* ← era #E67E22 */}
            <p style={{ fontFamily: "'Cinzel', serif", fontSize: "0.7rem", color: "#C0392B", letterSpacing: "0.3em", marginBottom: "0.75rem" }}>
              CÓMO TRABAJAMOS
            </p>
              ...
              <div key={step} className="proc-step relative">
                {i < PROCESS.length - 1 && (
                  <div
                    ...
                    style={{ background: "linear-gradient(90deg, rgba(46,134,171,0.3), transparent)", width: "100%" }}
                  />
                )}
                <div className="relative z-10 p-5 rounded-2xl"
                  style={{ background: "rgba(10,15,30,0.6)", border: "1px solid rgba(46,134,171,0.1)" }}>
                  <div
                    className="text-3xl font-black mb-3"
                    style={{
                      fontFamily: "'Cinzel', serif",
                      // ← era con naranja, ahora azul→rojo
                      background: "linear-gradient(135deg, rgba(46,134,171,0.5), rgba(192,57,43,0.4))",
                  ...
                  <h4 style={{ fontFamily: "'Cinzel', serif", fontSize: "0.9rem", color: "#E8EEF8", marginBottom: "0.5rem" }}>
                    {title}
                  </h4>
                  <p style={{ fontFamily: "'Exo 2', sans-serif", fontSize: "0.8rem", color: "#4A5A7A", lineHeight: 1.6 }}>
                    {desc}
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 px-6">
        <div
          ...
          style={{ background: "linear-gradient(135deg, rgba(27,79,114,0.2), rgba(192,57,43,0.1))", border: "1px solid rgba(46,134,171,0.2)" }}
        >
          {/* ← glow era naranja */}
          <div className="absolute inset-0 pointer-events-none"
            style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(192,57,43,0.08) 0%, transparent 70%)" }} />

          {/* ← era #E67E22 */}
          <Flame size={28} className="mx-auto mb-4" style={{ color: "#C0392B" }} />

          <h2 style={{ fontFamily: "'Cinzel', serif", fontSize: "clamp(1.4rem, 3vw, 2rem)", fontWeight: 700, color: "#F0F4FF", marginBottom: "0.75rem" }}>
            ¿No sabes cuál necesitas?
          </h2>
          <p style={{ fontFamily: "'Exo 2', sans-serif", fontSize: "0.95rem", color: "#4A5A7A", marginBottom: "2rem", lineHeight: 1.7 }}>
            Cuéntanos de tu negocio y te recomendamos la solución ideal sin compromisos.
          </p>
          <NavLink
            to="/contacto"
            ...
            onMouseEnter={e => (e.currentTarget.style.boxShadow = "0 8px 32px rgba(192,57,43,0.65)")}
            onMouseLeave={e => (e.currentTarget.style.boxShadow = "0 6px 24px rgba(192,57,43,0.4)")}
          >
            Consulta gratuita
